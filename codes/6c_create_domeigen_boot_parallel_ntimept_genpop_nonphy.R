...
# pattern by physical/non-physical contact and duration of contact
# prop.table(table(chk_contact_base[, c("phys_contact", "duration_multi")]), 1)
...
fname_out_RData = sprintf("domeigen_cntmat_ntimept_nboot%d_genpop_nonphycnt.RData", num_boot)
