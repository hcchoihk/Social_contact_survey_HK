...
fname_RData_cntmat_boot = "domeigen_cntmat_ntimept_nboot1000_genpop_nonphycnt.RData";
...
COLS_pick = c("All"="blue3", "Physical"="red2", "Nonphysical" = "darkgreen")
PCHS_pick = c("All"=16, "Physical"=18, "Nonphysical" = 17)

fname_excelout = sprintf("ratio_domeigenval_boot_genpop_%s_nonphy.xlsx", update_outputdate())
